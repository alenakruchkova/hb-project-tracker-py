...
def get_grade_by_github_title(github, title):
    ...
    QUERY = """
    SELECT grades.grade
    FROM grades WHERE grades.student_github = :github AND project_title = :title
    """
...
def assign_grade(github, title, grade):
    ...
    """
    cursor = db.session.execute(QUERY,{'github': github, 'title': title, 'grade': grade})
    db.session.commit()

    print "For student with github account %s for %s assignment grade was updated to %d"%(github, title, grade)
